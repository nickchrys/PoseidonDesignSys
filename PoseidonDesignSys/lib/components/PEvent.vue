...
<template>
    ...
    <template v-else>
        <div :class="giveDesign" @click="handleEventClick(event)" :style="{
            ...
            <div v-if="giveDesign.includes('p-event--block-planner')" class="pencil-icon-wrap" @click.stop="handleEditClick(event)">
                <svg 
                    class="pencil-icon" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
