...
const emit = defineEmits(['eventClick', 'backClick', 'editClick'])
...
<template>
    ...
    <template v-if="giveDesign.includes('p-event--small-header')">
        <div :class="giveDesign">
            <svg class="back-icon" @click="handleBackClick" width="16" height="32" viewBox="0 0 16 32">
